      ...
      <main className="main-content">
        <Container>
          <section className="hero-section text-center py-5 my-5">
            ...
            <h1 className="hero-title mb-3">Build Amazing Apps</h1>
            <p className="hero-subtitle text-muted mb-4">
              Modern React template with Bootstrap styling and best practices
            </p>
            <div className="cta-buttons">
              <button className="btn btn-primary btn-lg me-3 btn-custom">Get Started</button>
              <button className="btn btn-outline-secondary btn-lg btn-custom">Learn More</button>
            </div>
          </section>
